...
build-local:
	...
	docker build -t bde2020/hadoop-namenode:1.2.0-hadoop2.8-java8 ./namenode
	docker build -t bde2020/hadoop-datanode:1.2.0-hadoop2.8-java8 ./datanode
	docker build -t bde2020/hadoop-nodemanager:1.2.0-hadoop2.8-java8 ./nodemanager
	docker build -t bde2020/hadoop-resourcemanager:1.2.0-hadoop2.8-java8 ./resourcemanager
	docker build -t bde2020/hadoop-historyserver:1.2.0-hadoop2.8-java8 ./historyserver
